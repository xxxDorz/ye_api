...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断接口是否可被调用
        com.ye.yeapiclientsdk.model.User user = new com.ye.yeapiclientsdk.model.User();
        user.setUsername("test");
        String username = yeApiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        YeApiClient tempClient = new YeApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.ye.yeapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.ye.yeapiclientsdk.model.User.class);
