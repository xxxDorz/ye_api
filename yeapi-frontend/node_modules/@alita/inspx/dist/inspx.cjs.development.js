...
var popper = require('@radix-ui/popper');
...
function Inspect(_ref) {
  var children = _ref.children,
      ...
      disabled = _ref$disabled === void 0 ? "development" !== 'development' : _ref$disabled;
  var nodesAtPointerRef = React.useRef([]);
...
function createMarkerNode(text, type, popperOptions) {
  ...
  var _getPlacementData = popper.getPlacementData(_extends({
    popperSize: {
      width: popperWidth,
      height: popperHeight
    },
...
function createMargin(index, value, node, side) {
  ...
  var _getPlacementData2 = popper.getPlacementData({
    popperSize: {
      width: width,
      height: height
    },
...
function inspectMargin(nodes) {
  ...
  margins.forEach(function (margin, index) {
    ...
    createMarkerNode(String(margin), 'margin', {
      anchorRect: node.getBoundingClientRect(),
      side: popper.SIDE_OPTIONS[index],
      shouldAvoidCollisions: false,
      sideOffset: margin / 2 - 10
    });
    createMargin(index, margin, node, popper.SIDE_OPTIONS[index]);
  });
}
...
//# sourceMappingURL=inspx.cjs.development.js.map
